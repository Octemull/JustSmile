...
def face_swapping_manual(image_name,processed_image,face,face_loc):
    """
...
#    face = face_loc['Neutral_Face '+ str(n+1)]
#    converted_face_cord = face_cord(face_loc)
    raw_img = cv2.imread(image_name)
    raw_img[face_loc[0]:face_loc[1],face_loc[2]:face_loc[3],:] =  output_im
    cv2.imwrite("output.jpg", raw_img)
